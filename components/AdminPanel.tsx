  ...
  return (
    <>
      <div className="fixed top-2 right-4 z-50 group">
        <div
          className="text-xs text-green-900 group-hover:text-green-300 cursor-pointer font-mono"
          ...
          {submissions.length === 0 ? (
            ...
            <ul className="space-y-2 font-mono text-green-200">
              {submissions.map((file) => (
                <li
                  key={file.filename}
                  className="flex flex-col sm:flex-row sm:items-center sm:justify-between border border-green-800 px-4 py-2 rounded bg-black bg-opacity-40"
                >
                  <div>
