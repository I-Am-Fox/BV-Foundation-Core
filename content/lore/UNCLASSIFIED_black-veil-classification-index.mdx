...
---
### **ANCHOR**
**Containment Rating:** Passive Registry
**Threat Profile:** Inert / Structural
**Operational Status:** Internally Stabilized

Anchor-class anomalies exhibit ████████-level stabilization within fractured identity or paracognitive systems. While non-hostile, these assets are essential to ████████ cohesion and are to be preserved without intervention. Removal or suppression of Anchor entities has resulted in confirmed █████████ in ██% of studied events. Containment protocols are limited to passive observation and systemic integrity checks.
...
### **REVENANT**
**Containment Rating:** ████████
**Threat Profile:** Conditional / Reactive
**Operational Status:** ████████

Revenant-class anomalies are internally manifesting constructs forged under prolonged psychological duress. These entities exhibit █████████ directive programming, protective behavior, and ideostructural persistence. Though not inherently hostile, they may activate autonomously in defense of the host system. Full containment is impossible; behavioral monitoring is recommended. ████████ clearance required for engagement protocols.
