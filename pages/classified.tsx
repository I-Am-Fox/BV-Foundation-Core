      ...
      <div className="flex items-center justify-center min-h-screen bg-black text-white font-mono flicker">
        <div className="p-6 border border-red-600 bg-red-950/80 rounded shadow-lg">
          <h2 className="text-red-400 text-lg font-bold mb-2">
            RESTRICTED ACCESS // OVERSIGHT CONTROL
          </h2>
          <input
            type="password"
          ...
          {!error && (
            <p className="text-xs text-red-500 mt-2 animate-pulse">
              Initializing override handshake...
              <br />
    ...
    <div className="bg-black text-red-300 p-8 font-mono min-h-screen flicker">
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-1 text-sm">
          <li>
            <strong>ALPHA CLASS:</strong> Dimensional-impact anomalies. Level 5 required.
          </li>
          <li>
            <strong>THETA CLASS:</strong> Temporal and memory distortion. Level 4 clearance.
          </li>
          <li>
            <strong>DELTA CLASS:</strong> Corrupted entities. Obfuscation recommended.
          </li>
          <li>
            <strong>OCTANE CLASS:</strong> Physically volatile anomalies. Combat tags apply.
          </li>
          <li>
            <strong>FIELD AGENTS:</strong> Active human elements. Lower clearance observation.
          </li>
          <li>
            <strong>UNRESOLVED:</strong> Archived stasis files. Classification pending.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="text-sm space-y-1">
          <li>
            <span className="text-yellow-400">✔</span> Directive_14 — Memory Echo Protocol
          </li>
          <li>
            <span className="text-red-500">✖</span> Directive_19 — ███████████████
          </li>
        </ul>
      </section>
